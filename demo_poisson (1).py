...
import tarfile
file = tarfile.open('mri2fem.tar.gz')

print(file.getnames())
file.extractall('./fem',filter='data')
file.close()
...
import tarfile
file = tarfile.open('mri2fem-dataset.tar.gz')

print(file.getnames())
file.extractall('./mri2fem',filter='data')
file.close()
...
pip install trame-vtk trame-vuetify
